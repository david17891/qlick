// Loading skeleton para /eventos (catálogo público de eventos).
  ...
  return (
    ...
    >
      <div className="space-y-3 mb-8">
        <div className="h-9 bg-gradient-to-r from-purple-100 to-purple-50 rounded animate-pulse w-1/3" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          ...
          >
            <div className="h-40 bg-gradient-to-br from-purple-50 to-gray-50 animate-pulse" />
            <div className="p-4 space-y-2">
              ...
              <div className="flex justify-between items-center mt-3">
                <div className="h-6 w-20 bg-purple-50 rounded animate-pulse" />
