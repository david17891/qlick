// 404 branded para /eventos.
// AUDIT-010: SUPER_AUDIT_REMEDIATION_PROTOCOL.md Ola 2.

import Link from "next/link";

export default function EventosNotFound() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
      ...
      <p className="mt-3 text-lg text-gray-600 max-w-md">
        Es posible que el evento ya haya pasado o que el enlace haya
        cambiado. Te dejamos el catálogo completo.
      </p>
