...
- **Decision:**
  ...
  4. **Prueba end-to-end con tarjeta 4242**: el pago S� se proceso en Stripe (cuenta cct_1TqgUfRXKOh68uzN), pero el webhook reboto con 401 porque el whsec_ en Vercel no coincidian con el del webhook en Stripe. Bypass via script grant-david-access.mjs que replica la logica del webhook directo en DB.
